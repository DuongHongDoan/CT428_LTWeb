<?php
    ...
    $sql_products = "SELECT * FROM tbl_products WHERE tbl_products.id_danhmuc='$_GET[id]' LIMIT $begin,2";
    ...
    <div class="drop">
        ...
        <div class="dropdown drop-title">
            ...
            <ul class="dropdown-menu drop-hover">
                ...
                <li><a class="dropdown-item" href="#">Card bo góc</a></li>
            </ul>
        </div>
        <div class="dropdown">
    ...
    <div class="product-item">
        ...
        <ul class="pagination justify-content-center">
            ...
            <?php
                for($i=1; $i<=$trang; $i++){
            ?>
            <li class="page-item"><a <?php if($i==$page) {echo 'style="background-color: blue"';}else {echo '';}?> class="page-link" href="index.php?quanly=categories&id=<?php echo $row_page['id_danhmuc']?>&trang=<?php echo $i?>"><?php echo $i?></a></li>
            <?php
                }
            ?>
            <li class="page-item">
