...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="./assets/fontawesome-free-6.0.0-web/js/all.min.js"
    />
    <link
      rel="stylesheet"
  ...
  <body>
    ...
    <header>
      ...
      <div
        ...
        class="container-fluid navbar-init"
      >
    ...
    <div class="row justify-content-center" style="margin: 20px 0">
      <div class="col-sm-7">
        ...
        <div class="mb-3 mt-3">
          ...
          >
          <label for="email" class="form-label"
            >Đã có tài khoản: <a href="#">Đăng Nhập</a></label
          >
    ...
    <!-- Phan chan -->
    <footer
      class="text-center text-lg-start bg-opacity-100 text-muted"
      style="margin-top: 50px"
    >
      <section
        class="footertext"
        style="padding-top: 5px; background-color: #2e8b57"
      >
        <div class="container text-center text-md-start mt-5">
          <div class="row row-cols-3mt-3">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mx-auto mb-4">
              <h6 class="text-uppercase fw-bold mb-4">CHÍNH SÁCH SHOP</h6>
              <p>
            ...
            <div
              class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mx-auto mb-md-0 mb-4"
            >
          ...
          <div class="row row-cols-2">
            <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 mx-auto mb-4">
              <h6 class="text-uppercase fw-bold mb-4">THANH TOÁN</h6>
              <p>
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 mx-auto mb-4">
              <h6 class="text-uppercase fw-bold mb-4">VẬN CHUYỂN</h6>
              <p>
                <a href="#!" class="text-reset">Pricing</a>
              </p>
              <p>
